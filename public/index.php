...
<div class="off-canvas-content " data-off-canvas-content>
    <main class="grid-container  grid-container-padded" data-sticky-container>

        <header data-sticky data-options="marginTop:0;">
            <div class="grid-x  ">
                <div class="cell grid-x  small-1 medium-1 large-1 align-middle align-center">
                    <button type="button" class="menu-icon dark button_burger_open" title="menu" data-toggle="offCanvas">
                    </button>
                </div>
                <div class="cell grid-x align-center small-2 medium-7 large-4 large-offset-3">
                    LOGO
                </div>
            </div>
        ...
        <section class="grid-container vertical-padding">
            <div class="grid-x">
